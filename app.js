...
// ── Init ──────────────────────────────────────────────────────────────────────
applyLang();
document.getElementById("share-art-btn").addEventListener("click", () => {

const img = document.getElementById("lightbox-img").src;
const title = document.getElementById("lightbox-title").innerText;
const artist = document.getElementById("lightbox-artist").innerText;
const date = document.getElementById("lightbox-date").innerText;
...
ctx.drawImage(artwork,90,120,900,900);

ctx.fillStyle="#333";
ctx.font="40px sans-serif";
ctx.fillText(title,90,1050);

ctx.font="32px sans-serif";
ctx.fillText(artist,90,1100);

ctx.fillText(date,90,1150);

const link=document.createElement("a");
link.download="kids-art.png";
